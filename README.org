#+TITLE: Learning Rust for C++ Robotics Engineers
#+AUTHOR: Rust Learning Repository
...
** [[file:modules/01_basics_ownership/README.org][Module 1: Basics and Ownership]]
...
** [[file:modules/02_borrowing_lifetimes/README.org][Module 2: Borrowing and Lifetimes]]
...
** [[file:modules/03_structs_enums/README.org][Module 3: Structs, Enums, and Pattern Matching]]
...
** [[file:modules/04_error_handling/README.org][Module 4: Error Handling]]
- Result and Option types (no exceptions!)
- The =?= operator
- Recoverable vs unrecoverable errors
- Why Rust chose this approach

** [[file:modules/05_traits_generics/README.org][Module 5: Traits and Generics]]
- Traits (similar to interfaces/type classes)
- Generic programming
- Trait bounds
- Comparison with C++ templates and concepts

** [[file:modules/06_collections_iterators/README.org][Module 6: Collections and Iterators]]
- Vec, HashMap, HashSet
- Iterator patterns and adapters
- Zero-cost abstractions
- Functional programming style

** [[file:modules/07_concurrency/README.org][Module 7: Concurrency and Smart Pointers]]
...
- [[https://doc.rust-lang.org/book/][The Rust Book]] - Official comprehensive guide
- [[https://doc.rust-lang.org/rust-by-example/][Rust by Example]] - Learn by example
...
Track your learning progress in [[file:PROGRESS.org][PROGRESS.org]]
